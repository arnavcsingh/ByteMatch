...
import { Clock, Users, ChefHat, Heart, ExternalLink, Sparkles, Star, X, Zap, AlertCircle } from "lucide-react";
...
export default function RecipeCard({
  ...
  // Calculate nutrition when component mounts
  useEffect(() => {
        ...
        <div className="mb-6">
          ...
          {nutritionLoading && (
            <div className="flex items-center justify-center py-4">
              ...
              <span className="ml-2 text-sm text-gray-600">Calculating nutrition...</span>
            </div>
          )}
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-4 border border-green-200/50 shadow-sm">
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                <div className="text-center">
                  ...
                  <div className="text-xs text-green-600 font-semibold">Calories</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-700">{nutrition.protein}g</div>
                  <div className="text-xs text-blue-600 font-semibold">Protein</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-700">{nutrition.carbs}g</div>
                  <div className="text-xs text-orange-600 font-semibold">Carbs</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-700">{nutrition.fat}g</div>
          ...
          {nutritionError && (
            <div className="flex items-center justify-center py-4 bg-gray-50 rounded-2xl border border-gray-200/50">
              <AlertCircle className="w-4 h-4 text-gray-500 mr-2" />
              <span className="text-sm text-gray-600">{nutritionError}</span>
            </div>
          )}
